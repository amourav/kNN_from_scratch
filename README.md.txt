...
source httpsen.wikipedia.orgwikiK-nearest_neighbors_algorithm
...
![Image](httpsgithub.comamouravkNearestNeighborreadme_imgsiris.png)

Iris Flower Species ([source] (httpswww.flickr.comphotosgmayfield103352170798inphotostream))
...
# trntest split - only use first two features
